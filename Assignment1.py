...
courses_this_semester = ["MCS 251 - Data Structures and Algorithm 1", "MCS 253 - Computer Programming 1", "MA 221 - Calculus 1", "MA 211 - Set Theory and Logic", "MA 241 - Discrete Mathematics 1"]
...
"""
print("Data type of courses_this_semester:\n", type(courses_this_semester))
print()
