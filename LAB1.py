...
print("Welcome, user. I am a Rectangle Perimeter and Area calculator.\n")

# Ask for user input
userchoice = input("To calculate the area of a rectangle, enter 1.\nTo calculate the perimeter of a rectangle, enter 2.\n")
